...
namespace SistemaPreventa.Formularios
{
    public partial class frmLogin : Form
    {
        ...
        {
            this.pnlLogin.Left = (this.Width / 2) - (this.pnlLogin.Width / 2);
            this.pnlLogin.Top = (this.Height / 2) - (this.pnlLogin.Height / 2);
        }
        ...
        {
            btnIngresar.BackColor = Color.DarkOrchid;
        }
        ...
        {
            btnCerrar.BackColor = Color.DarkOrchid;
        }
        ...
        {
            Formularios.frmRegistro fReg = new Formularios.frmRegistro();
            fReg.ShowDialog();
            //this.Hide();
        }
        ...
        {
            Formularios.frmOlvido fOlv = new Formularios.frmOlvido();
            fOlv.ShowDialog();
        }
    }
}
